   ...
   return (
      ...
      gap={0} textAlign='center' >
         ...
         <GridItem colStart={3} colEnd={8} mt='auto' display={['none', 'none', 'none','GridItem']} fontWeight='300' color='salt' >
            <HStack spacing={2} mx='auto' fontSize='1rem' letterSpacing={2}>
                  {menu.map(item => {
                     return (
                        <NavItem
                        key={item.id}
         ...
         <GridItem colStart={8} colEnd={9}  mt='auto' display={['none', 'none', 'none','GridItem']} >
            ...
            <SimpleGrid ml={4} spacing={2} columns={3} fontSize='1.5rem'>
               <Link  _hover={{color: "salt"}} color='salmon' mt='auto' href='https://www.linkedin.com/company/awer-assessoria-de-gest%C3%A3o-e-solu%C3%A7%C3%B5es-tecnol%C3%B3gicas/'> <FaLinkedin/> </Link>
               <Link _hover={{color: "salt"}} color='salmon' mt='auto' href='https://www.instagram.com/awer.consultoria/'> <FaInstagram/> </Link>
               <Link  _hover={{color: "salt"}} color='salmon' mt='auto' href='https://wa.me/5516992679694'> <BsWhatsapp/> </Link>
            </SimpleGrid >
         </GridItem>

...
export default function NotFound () {
   ...
   return (
      <Container maxW='100vw' minH='100vh' bg='gun' p={5} m='0' color='salt' centerContent>
         ...
         <Box maxW={['100vw','90vw','75vw','50vw']} my='auto' >
            ...
            <Link _hover={{color: "salmon"}} mx='auto' cursor='pointer'  border='1px' borderRadius={4} p={2} href='/'>
